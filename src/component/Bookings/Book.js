                        ...
                        <Paper elevation={2} className='col-sm-10 col-md-8 col-lg-6 col-xl-3 '>
                            ...
                            <Form className='main-form-div '>
                                <div style={{ display: 'flex', flexDirection: 'column' }} className='gap-3 p-3'>
                                    <Field as={TextField} name="pickup_Location" label="Pickup Location" sx={{ marginBottom: '5px' }} />
                                    <ErrorMessage name='pickup_Location' />
                                    <Field as={TextField} name="dropoff_Location" label="Dropoff Location" sx={{ marginBottom: '5px' }} />
                                    <ErrorMessage name='dropoff_Location' />
                                    <Stack sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
                                        <Typography textAlign={"center"} sx={{ color: 'Black' }}>Start Date</Typography>
                                    ...
                                    <Stack sx={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
                                        <Typography textAlign={"center"} sx={{ color: 'Black' }}>End Date</Typography>
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                                            <DatePicker
                                                value={returnDate}
